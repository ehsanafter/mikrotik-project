# feb/18/2022 18:16:57 by RouterOS 7.1.1
...
/ip address
add address=172.16.2.1 interface=lo network=172.16.2.1
...
add address-families=ip as=100 connect=yes disabled=no listen=yes local.role=\
    ebgp name=Peer100 output.network=bgp_advertise remote.address=10.0.0.2/32 \
    .as=200 router-id=172.16.2.1 routing-table=main
/system identity
set name=ISP-A
